...
internal class DeleteRoleEventHandler : INotificationHandler<RoleDeletedDomainEvent>
{
    private readonly IRoleRepository _roleRepository;
    private readonly IAuditLogService _auditLogService;

    public DeleteRoleEventHandler(IRoleRepository roleRepository, IAuditLogService auditLogService)
    {
