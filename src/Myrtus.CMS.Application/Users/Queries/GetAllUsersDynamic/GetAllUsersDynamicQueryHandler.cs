...
public sealed class GetAllUsersDynamicQueryHandler
    : IRequestHandler<GetAllUsersDynamicQuery, Result<IPaginatedList<GetAllUsersDynamicQueryResponse>>>
{
    ...
    public async Task<Result<IPaginatedList<GetAllUsersDynamicQueryResponse>>> Handle(
        GetAllUsersDynamicQuery request,
